...
import datetime
from kitsocms import __shortversion__
...
html_logo = '_static/kitsocms_light.png'
...
latex_documents = [
    (master_doc, 'Kitsocms.tex', 'CodeRed CMS Documentation',
     'CodeRed LLC', 'manual'),
]
...
man_pages = [
    (master_doc, 'kitsocms', 'CodeRed CMS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Kitsocms', 'CodeRed CMS Documentation',
     author, 'Kitsocms', 'One line description of project.',
     'Miscellaneous'),
]

...
class ClassifierTermChooserBlock(blocks.FieldBlock):
    ...
    def target_model(self):
        return resolve_model_string('kitsocms.ClassifierTerm')
...
class KitsoAdvSettings(blocks.StructBlock):
    """
...
class KitsoAdvTrackingSettings(KitsoAdvSettings):
    """
    KitsoAdvSettings plus additional tracking fields.
    """
...
class KitsoAdvColumnSettings(KitsoAdvSettings):
    """
...
class BaseBlock(blocks.StructBlock):
    """
    Common attributes for all blocks used in Kitso CMS.
    """
    # subclasses can override this to determine the advanced settings class
    advsettings_class = KitsoAdvSettings

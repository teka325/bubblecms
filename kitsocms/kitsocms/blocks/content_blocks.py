...
class CardBlock(BaseBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/card_foot.html'
        icon = 'fa-list-alt'
        label = _('Card')
...
class CarouselBlock(BaseBlock):
    ...
    """
    carousel = SnippetChooserBlock('kitsocms.Carousel')

    class Meta:
        icon = 'image'
        label = _('Carousel')
        template = 'kitsocms/blocks/carousel_block.html'
...
class ImageGalleryBlock(BaseBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/image_gallery_block.html'
        icon = 'image'
...
class ModalBlock(ButtonMixin, BaseLayoutBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/modal_block.html'
...
class NavExternalLinkBlock(NavBaseLinkBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/external_link_block.html'
...
class NavPageLinkBlock(NavBaseLinkBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/page_link_block.html'
        label = _('Page Link')
...
class NavDocumentLinkBlock(NavBaseLinkBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/document_link_block.html'
...
class PriceListItemBlock(BaseBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/pricelistitem_block.html'
        icon = 'fa-usd'
...
class PriceListBlock(BaseBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/pricelist_block.html'
        icon = 'fa-usd'
        label = _('Price List')
...
class ContentWallBlock(BaseBlock):
    ...
    """
    content_wall = SnippetChooserBlock('kitsocms.ContentWall')
    ...
    class Meta:
        ...
        template = 'kitsocms/blocks/content_wall_block.html'
...
class ReusableContentBlock(BaseBlock):
    ...
    """
    content = SnippetChooserBlock('kitsocms.ReusableContent')

    class Meta:
        icon = 'fa-recycle'
        label = _('Reusable Content')
        template = 'kitsocms/blocks/reusable_content_block.html'

...
class ButtonBlock(ButtonMixin, BaseLinkBlock):
    ...
    """
    class Meta:
        template = 'kitsocms/blocks/button_block.html'
...
class DownloadBlock(ButtonMixin, BaseBlock):
    ...
    advsettings_class = KitsoAdvTrackingSettings

    class Meta:
        template = 'kitsocms/blocks/download_block.html'
        icon = 'download'
        label = _('Download')
...
class EmbedGoogleMapBlock(BaseBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/google_map.html'
        icon = 'fa-map'
        label = _('Google Map')
...
class EmbedVideoBlock(BaseBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/embed_video_block.html'
        icon = 'media'
        label = _('Embed Media')
...
class H1Block(BaseBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/h1_block.html'
        icon = 'fa-header'
        label = _('Heading 1')
...
class H2Block(BaseBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/h2_block.html'
        icon = 'fa-header'
        label = _('Heading 2')
...
class H3Block(BaseBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/h3_block.html'
        icon = 'fa-header'
        label = _('Heading 3')
...
class TableBlock(BaseBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/table_block.html'
        icon = 'fa-table'
        label = 'Table'
...
class ImageBlock(BaseBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/image_block.html'
        icon = 'image'
        label = _('Image')
...
class ImageLinkBlock(BaseLinkBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/image_link_block.html'
        icon = 'image'
        label = _('Image Link')
        value_class = LinkStructValue
...
class PageListBlock(BaseBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/pagelist_block.html'
        icon = 'list-ul'
    ...
    def get_context(self, value, parent_context=None):
        ...
        # try to use the KitsoPage `get_index_children()`,
        # but fall back to get_children if this is a non-KitsoPage
        if hasattr(indexer, 'get_index_children'):
            ...
            if value['classified_by']:
                try:
                    ...
                    # `pages` is not a queryset, or is not a queryset of KitsoPage.
                    logger.warning(
                        "Tried to filter by ClassifierTerm in PageListBlock, but <%s.%s ('%s')>.get_index_children()  # noqadid not return a queryset or is not a queryset of KitsoPage models.",  # noqa
...
class PagePreviewBlock(BaseBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/pagepreview_block.html'
...
class QuoteBlock(BaseBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/quote_block.html'
        icon = 'openquote'
        label = _('Quote')
...
class RichTextBlock(blocks.RichTextBlock):
    class Meta:
        template = 'kitsocms/blocks/rich_text_block.html'

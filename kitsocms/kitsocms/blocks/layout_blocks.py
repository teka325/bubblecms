...
from .base_blocks import BaseLayoutBlock, KitsoAdvColumnSettings
...
class ColumnBlock(BaseLayoutBlock):
    ...
    advsettings_class = KitsoAdvColumnSettings

    class Meta:
        template = 'kitsocms/blocks/column_block.html'
        icon = 'placeholder'
        label = 'Column'
...
class GridBlock(BaseLayoutBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/grid_block.html'
        icon = 'fa-columns'
...
class CardGridBlock(BaseLayoutBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/cardgrid_deck.html'
        icon = 'fa-th-large'
        label = _('Card Grid')
...
class HeroBlock(BaseLayoutBlock):
    ...
    class Meta:
        template = 'kitsocms/blocks/hero_block.html'
        icon = 'fa-newspaper-o'
        label = 'Hero Unit'

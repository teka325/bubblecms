...
from kitsocms.utils import attempt_protected_media_value_conversion
...
class CoderedDateInput(forms.DateInput):
    template_name = 'kitsocms/formfields/date.html'
...
class CoderedDateTimeInput(forms.DateTimeInput):
    template_name = 'kitsocms/formfields/datetime.html'
...
class CoderedTimeInput(forms.TimeInput):
    template_name = 'kitsocms/formfields/time.html'
...
def get_page_model_choices():
    ...
    """
    from kitsocms.models import get_page_models
    return (
        (
            page.__name__,
            re.sub(

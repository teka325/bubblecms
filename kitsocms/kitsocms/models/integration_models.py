...
from kitsocms.api.mailchimp import MailchimpApi
...
class MailchimpSubscriberIntegrationWidget(Input):
    template_name = 'kitsocms/formfields/mailchimp/subscriber_integration_widget.html'
    js_template_name = 'kitsocms/formfields/mailchimp/subscriber_integration_js.html'

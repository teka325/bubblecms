...
DEFAULTS = {
    ...
    'FRONTEND_TEMPLATES_BLOCKS': {
        'cardblock': (
            ('kitsocms/blocks/card_block.html', 'Card'),
            ('kitsocms/blocks/card_head.html', 'Card with header'),
            ('kitsocms/blocks/card_foot.html', 'Card with footer'),
            ('kitsocms/blocks/card_head_foot.html', 'Card with header and footer'),
            ('kitsocms/blocks/card_blurb.html', 'Blurb - rounded image and no border'),
            ('kitsocms/blocks/card_img.html', 'Cover image - use image as background'),
        ),
        'cardgridblock': (
            ('kitsocms/blocks/cardgrid_group.html', 'Card group - attached cards of equal size'),
            ('kitsocms/blocks/cardgrid_deck.html', 'Card deck - separate cards of equal size'),
            ('kitsocms/blocks/cardgrid_columns.html', 'Card masonry - fluid brick pattern'),
        ),
        'pagelistblock': (
            ('kitsocms/blocks/pagelist_block.html', 'General, simple list'),
            ('kitsocms/blocks/pagelist_list_group.html', 'General, list group navigation panel'),
            ('kitsocms/blocks/pagelist_article_media.html', 'Article, media format'),
            ('kitsocms/blocks/pagelist_article_card_group.html',
                'Article, card group - attached cards of equal size'),
            ('kitsocms/blocks/pagelist_article_card_deck.html',
             'Article, card deck - separate cards of equal size'),
            ('kitsocms/blocks/pagelist_article_card_columns.html',
             'Article, card masonry - fluid brick pattern'),
        ),
        'pagepreviewblock': (
            ('kitsocms/blocks/pagepreview_card.html', 'Card'),
            ('kitsocms/blocks/pagepreview_form.html', 'Form inputs'),
        ),
    ...
    'FRONTEND_TEMPLATES_PAGES': {
        ...
        '*': (
            ('', 'Default'),
            ('kitsocms/pages/web_page.html', 'Web page showing title and cover image'),
            ('kitsocms/pages/web_page_notitle.html', 'Web page without title and cover image'),
            ('kitsocms/pages/home_page.html', 'Home page without title and cover image'),
            ('kitsocms/pages/base.html', 'Blank page - no navbar or footer'),
        ),
    },

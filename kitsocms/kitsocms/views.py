...
from kitsocms.importexport import convert_csv_to_json, import_pages, ImportPagesFromCSVFileForm
...
def search(request):
    ...
    # Render template
    return render(request, 'kitsocms/pages/search.html', {
        'request': request,
        'pagetypes': pagetypes,
        'form': search_form,
        'results': results,

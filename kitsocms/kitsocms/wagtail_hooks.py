...
from kitsocms.wagtail_flexible_forms.wagtail_hooks import FormAdmin, SubmissionAdmin
...
def global_admin_css():
    return format_html(
        ...
        static('kitsocms/css/codered-admin.css')
    )
...
def editor_css():
    return format_html(
        '<link rel="stylesheet" type="text/css" href="{}">',
        static('kitsocms/css/codered-editor.css')
    )


@hooks.register('insert_editor_js')
def collapsible_js():
    return format_html('<script src="{}"></script>', static('kitsocms/js/codered-editor.js'))
...
def codered_forms(user, editable_forms):
    from kitsocms.models import CoderedFormMixin
    """
...
class CoderedSubmissionAdmin(SubmissionAdmin):
    ...
    def __init__(self, parent=None):
        from kitsocms.models import CoderedSessionFormSubmission
...
class CoderedFormAdmin(FormAdmin):
    ...
    def action_links(self, obj):
        from kitsocms.models import CoderedFormPage, CoderedStreamFormPage
        actions = []
